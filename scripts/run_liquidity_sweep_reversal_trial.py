"""scripts/run_liquidity_sweep_reversal_trial.py -- Phase 4.E LiquiditySweepReversal full_cpcv trial.

Thin wrapper; all logic in scripts/phase4e_trial_common.py: dual-fee gate
(Gate 1), CPCVError-safe retire row, per-bar store. Single-pair BTCUSDT 15m,
...
if __name__ == "__main__":
    raise SystemExit(run("LiquiditySweepReversal"))
